...
class GameMenu:
    ...
    def load_data(self, shop_data: Dict[str, Any]) -> None:
    ...
    def save_shop_state(self, selected_accessory_type: int) -> None:
    ...
    def show_instructions_menu(self) -> None:
    ...
    def close_instructions(self) -> None:
        self.show_instructions = False
    ...
    def continue_game_from_shop(self) -> None:
        self.continue_game()

    def back_to_shop(self) -> None:
        self.show_selection = False
        self.show_shop = True

    def buy_item(self, item: str, cost: int) -> bool:
    ...
    def select_accessory(self, accessory_type: int) -> int:
        return accessory_type

    def draw(self, surface: pygame.Surface, selected_accessory_type: int) -> None:
        if not self.active:
            return
    ...
    def draw_selection(self, surface: pygame.Surface, selected_accessory_type: int) -> None:
        overlay = pygame.Surface((SCREEN_WIDTH, SCREEN_HEIGHT), pygame.SRCALPHA)
